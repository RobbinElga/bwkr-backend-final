...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'ability:staff'])->prefix('admin')->group(function () {
        ...
        // ===== SUPER ADMIN (trash/restore + manajemen) — DIDAFTARKAN DULU =====
        ...
        Route::middleware('role:super_admin,admin')->group(function () {
            ...
            Route::apiResource('bank-accounts', AdminBankAccountController::class)->only(['store', 'update', 'destroy']);
